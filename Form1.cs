...
namespace BeautyBuzz
{
    public partial class Form1 : Form
    {
       ...
       private void CheckForDigits(TextBox textBox, KeyPressEventArgs e)
        ...
        private void SignUp_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Inregistrare reusita!", "Succes");
        }
        ...
        private int consecutiveDigitsCount = 0;
        ...
        {
            // Generati un cod de verificare aleatoriu
    ...
    {
        // Adresa de email și parola pentru autentificarea pe serverul SMTP2GO
        string smtpUsername = "Brujbeanu Gabriel";
        string smtpPassword = "MARILENAbrj18";

        // Configurațiile serverului SMTP2GO
        string smtpHost = "mail.smtp2go.com";
        int smtpPort = 2525; // Portul SMTP2GO

        // Adresa de email de la care se trimite codul de verificare
        string fromAddress = "gabriel.brujbeanu@student.unitbv.ro";

        // Configurațiile clientului SMTP
        SmtpClient client = new SmtpClient(smtpHost, smtpPort);
        client.UseDefaultCredentials = false;
        client.Credentials = new NetworkCredential(smtpUsername, smtpPassword);
        client.EnableSsl = true; // Asigurati-va ca utilizam SSL

        // Construiti mesajul de email
        MailMessage mailMessage = new MailMessage();
        mailMessage.From = new MailAddress(fromAddress);
        mailMessage.To.Add(email);
        mailMessage.Subject = "Cod de verificare";
        mailMessage.Body = "Codul dvs. de verificare este: " + verificationCode;

        try
         {
            // Trimiteti email-ul
            client.Send(mailMessage);
            MessageBox.Show("Codul de verificare a fost trimis la adresa de email specificată.");
        }
        catch (Exception ex)
        {
            MessageBox.Show("Eroare la trimiterea codului de verificare prin email: " + ex.Message);
        }
    }
